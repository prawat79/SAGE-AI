...
DROP TRIGGER IF EXISTS update_character_ratings_updated_at ON character_ratings;
...
-- Drop existing triggers if they exist before creating new ones
DROP TRIGGER IF EXISTS update_character_like_stats ON character_likes;
DROP TRIGGER IF EXISTS update_character_rating_stats ON character_ratings;
...
-- Drop existing policies if they exist before creating new ones
DROP POLICY IF EXISTS "Users can view all character likes" ON character_likes;
DROP POLICY IF EXISTS "Users can create own likes" ON character_likes;
DROP POLICY IF EXISTS "Users can delete own likes" ON character_likes;
...
-- Drop existing policies if they exist before creating new ones
DROP POLICY IF EXISTS "Users can view all character ratings" ON character_ratings;
DROP POLICY IF EXISTS "Users can create own ratings" ON character_ratings;
DROP POLICY IF EXISTS "Users can update own ratings" ON character_ratings;
DROP POLICY IF EXISTS "Users can delete own ratings" ON character_ratings;
...
-- Drop existing policies if they exist before creating new ones
DROP POLICY IF EXISTS "Anyone can view character categories" ON character_categories;
